...
class CommentRepositoryTest {
    ...
    void findByArticleId2() {
        ...
        List<Comment> expected = Arrays.asList(); // 9번 게시글은 존재 하지 않음
    ...
    void findByArticleId999() {
        /* Case 4: 999번 게시글의 모든 댓글 조회 */
        {
            ...
            // 3. 예상 데이터
            Article article = null;
            List<Comment> expected = Arrays.asList(); // 999번 게시글은 존재 하지 않음
